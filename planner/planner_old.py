...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        planner.handle_beta_blocking(obj)
    ...
    try:
        ...
        while running:
            ...
            if has_therapy_changed(old_therapy,planner.therapy) and new_message == True:
                ...
                therapies = copy.deepcopy(planner.therapy)
                therapies['carvedilolo_beta_blocking']+= planner.therapy['improve_beta_blocking']
                therapies.pop('improve_beta_blocking')
                send_status(mqtt_client, therapies)
